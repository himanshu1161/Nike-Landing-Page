  ...
  return (
    ...
    font-bold lg:max-w-lg'>
      ...
      <p className='mt-4 lg:max-w-lg info-text'>
       Embark on a shopping journey that redefines your experinece 
       with unbeateable deals. from premier sections to incredible savings.
       we offer unparalleld value that sets us apart.
      </p>
      <p className='mt-6 lg:max-w-lg info-text'>
       Navigate a realm of possibilites desgined to fulfill your unique
